...
package com.bigbug.android.pp.sync.userdata;
...
import com.bigbug.android.pp.util.Lists;
...
//            ops.add(op);
        ...
        try {
            ContentProviderResult[] result = mContext.getContentResolver().applyBatch(AppContract.CONTENT_AUTHORITY, ops);
