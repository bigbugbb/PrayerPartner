...
//                .build();
    ...
    public void onDestroy() {
        ...
        PPBroadcastReceiver.completeWakefulIntent(mIntent);
    }
    ...
    private void sendNotification(String msg) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(
                mContext, 0, new Intent(this, MainActivity.class), PendingIntent.FLAG_UPDATE_CURRENT);
...
//            final long trackId = AppContract.Tracks.getTrackIdToday(mContext);
...
//                    values.put(AppContract.SyncColumns.UPDATED, DateTime.now().getMillis());
